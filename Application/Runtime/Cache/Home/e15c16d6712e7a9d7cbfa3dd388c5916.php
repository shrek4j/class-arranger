<?php if (!defined('THINK_PATH')) exit();?> <html>
  ...
  <!--  <link rel="stylesheet" type="text/css" href="http://www.jeasyui.com/easyui/demo/demo.css"> -->
    ...
    <body style="background:#33a3dc;">
        <div style="display:block;">
            <form method="post" action="doLogin" novalidate="novalidate">
                <div class="input-wrapper">
                    <input required type="loginname" name="loginname" placeholder="用户名"/>
                </div>
                <div class="input-wrapper">
                ...
                <div class="button-wrapper command">
                    <button class="sign-button" type="submit">登录classOA</button>
                </div>
            </form>
        </div>
    </body>
