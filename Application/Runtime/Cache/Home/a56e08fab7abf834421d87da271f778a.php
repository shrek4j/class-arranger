...
<div class="main-view">
        <div class="main-view-inner container-fluid">
            <div class="row">
                <div class="col-md-4 key row-gutter">教室名称：</div>
                <div class="col-md-4 value"><input id="classroom" type="text" class="form-control" value="" aria-describedby="basic-addon1"/></div>
                <div class="col-md-2 remark"><span>必填</span></div>
            </div>
            <div class="row">
                <div class="col-md-6 key row-gutter"><button type="button" class="btn btn-default btn-submit add-classroom">保存</button></div>
            </div>
    </div>
